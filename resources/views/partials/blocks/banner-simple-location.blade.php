@if (get_row_layout() == 'banner_simple_location')
    ...
    @endphp
    <section data-animate="slide-up" class="banner-simple-location px-4 pb-0 pb-lg-5 pt-5 bg-white"
        id="banner-location-@php echo get_row_index() @endphp" style="
        ...
        <div class="container">
            <div class="row {{ !empty($background_image) ? 'location-text' : '' }} py-5">
                <div class="col-12 col-lg-6 text-center pe-lg-5">
                    ...
                    @endif
                    <h2 class="text-center text-brown py-3 position-relative mx-auto">{{ the_sub_field('title') }}
                    </h2>
                    ...
                    @if ($link)
                        @php
                          ...
                          @endphp
                        <a class="btn btn-brown right-arrow position-relative mb-5" href="@php echo esc_url($link_url) @endphp"
