...
@endphp
<section class="banner-simple-stacked in-page-section vh-100 d-flex align-items-end position-relative bg-white" id="banner-simple-@php echo get_row_index() @endphp">
