@if (get_row_layout() == 'banner_simple_right_side_label')
    ...
    <section data-animate="fade-in"
        class="banner-pillar in-page-section position-relative vh-100 d-flex align-items-end justify-content-end">
        @if ($background_image)
            <img src="{{ $background_image['url'] }}" alt="{{ $background_image['alt'] }}"
                class="position-absolute top-0 start-0 w-100 vh-100 object-fit-cover">
        @endif
        <div class="z-1 max-width-600 d-flex align-items-center justify-content-end py-5 px-5"
            style="background-color: rgba(242, 237, 233, 0.9); border-top-left-radius: 130px; height: auto;">
